...
> **Note**: For EgoDex integration, you can use `molmoact-midtrain-egodex-pose`, `egodex-pose-only`, or scaling configurations (`molmoact-midtrain-egodex-scaling-{25,50,100}pct`) as the mixture name to train with EgoDex data. See `EGODEX_INTEGRATION.md` for detailed instructions and visualization tools.
